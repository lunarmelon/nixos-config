{pkgs, ...}: {
  ...
  opts = {
    ...
    completeopt = ["menuone" "noselect" "noinsert"]; # Set completeopt to have a better completion experience (default: 'menu,preview)
    ...
    updatetime = 50; # Decrease update time (default: 4000)
